 ...
 *
 *
 * @package    propel.generator.vendor\creonit\content-bundle.Model.Base
 */
abstract class Content implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Creonit\\ContentBundle\\Model\\Map\\ContentTableMap';
    ...
    /**
     * Initializes internal state of Creonit\ContentBundle\Model\Base\Content object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\Creonit\ContentBundle\Model\Content The current object (for fluent API support)
     */
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[ContentTableMap::COL_TEXT] = true;
        }
    ...
    public function setCompleted($v)
    {
        ...
        if ($this->completed !== $v) {
            $this->completed = $v;
            $this->modifiedColumns[ContentTableMap::COL_COMPLETED] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ContentTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ContentTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ContentTableMap::translateFieldName('Text', TableMap::TYPE_PHPNAME, $indexType)];
            $this->text = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ContentTableMap::translateFieldName('Completed', TableMap::TYPE_PHPNAME, $indexType)];
            $this->completed = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ContentTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ContentTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->updated_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ContentTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = ContentTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Creonit\\ContentBundle\\Model\\Content'), 0, $e);
        }
    }
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ContentTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ContentTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ContentTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ContentTableMap::COL_TEXT)) {
            $modifiedColumns[':p' . $index++]  = '`text`';
        }
        if ($this->isColumnModified(ContentTableMap::COL_COMPLETED)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Creonit\ContentBundle\Model\Content
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Creonit\ContentBundle\Model\Content The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ContentTableMap::COL_TEXT)) {
            $criteria->add(ContentTableMap::COL_TEXT, $this->text);
        }
        if ($this->isColumnModified(ContentTableMap::COL_COMPLETED)) {
            $criteria->add(ContentTableMap::COL_COMPLETED, $this->completed);
        }
        if ($this->isColumnModified(ContentTableMap::COL_CREATED_AT)) {
            $criteria->add(ContentTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(ContentTableMap::COL_UPDATED_AT)) {
            $criteria->add(ContentTableMap::COL_UPDATED_AT, $this->updated_at);
        }
        if ($this->isColumnModified(ContentTableMap::COL_ID)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Creonit\ContentBundle\Model\Content (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Creonit\ContentBundle\Model\Content Clone of current object.
     * @throws PropelException
     */
    ...
    public function initPages($overrideExisting = true)
    {
        ...
        $this->collPages->setModel('\Creonit\PageBundle\Model\Page');
    }
     ...
     */
    protected function doAddPage(Page $page)
    {
        $this->collPages[]= $page;
     ...
     * @return ObjectCollection|Page[] List of Page objects
     */
    public function getPagesJoinPageRelatedByLinkId(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = PageQuery::create(null, $criteria);
        $query->joinWith('PageRelatedByLinkId', $joinBehavior);
     ...
     * @return ObjectCollection|Page[] List of Page objects
     */
    public function getPagesJoinPageRelatedByParentId(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = PageQuery::create(null, $criteria);
        $query->joinWith('PageRelatedByParentId', $joinBehavior);
